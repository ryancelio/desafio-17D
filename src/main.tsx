...
// --- Etapas do Onboarding (Crie estes arquivos) ---
import Step1_Profile from "./routes/onboarding/steps/Step1_Profile";
import Step2_Goals from "./routes/onboarding/steps/Step2_Goals";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                {/* O OnboardingLayout contém o Provider e o <Outlet> */}
                <OnboardingLayout />
              </ProtectedRoute>
            }
          >
            {/* Redireciona de /onboarding para a primeira etapa */}
            <Route index element={<Navigate to="profile" replace />} />

            {/* As etapas são renderizadas dentro do <Outlet> do OnboardingLayout */}
