...
const FeatureCard: React.FC<{
  ...
  >
    <div className="h-12 w-12 bg-pasPink/20 rounded-2xl flex items-center justify-center text-gray-900 mb-4">
...
const BenefitItem: React.FC<{ text: string }> = ({ text }) => (
  <div className="flex items-center gap-3 mb-3">
    <div className="shrink-0 h-6 w-6 rounded-full bg-pasGreen flex items-center justify-center text-gray-800">
  ...
  return (
    <LandingLayout>
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        {/* Background Blobs */}
        <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-pasPink/30 rounded-full blur-3xl -z-10" />
        <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-80 h-80 bg-pasGreen/30 rounded-full blur-3xl -z-10" />
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left space-y-6">
            ...
            >
              <span className="inline-block px-4 py-1.5 rounded-full bg-pasPink/20 text-gray-900 text-sm font-bold uppercase tracking-wide mb-4 border border-pasPink/30">
            ...
            >
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-pasPink hover:bg-pasPink/90 text-gray-900 rounded-2xl font-bold text-lg shadow-xl shadow-pasPink/30 transition-all active:scale-95 flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-6 flex items-center justify-center lg:justify-start gap-6 text-sm text-gray-500">
              <span className="flex items-center gap-1">
                <LuClipboardList className="text-pasGreen" /> Análise de perfil
                grátis
              </span>
              <span className="flex items-center gap-1">
                <LuCheckCircle className="text-pasGreen" /> Sem compromisso
              </span>
            </div>
          </div>
          ...
          >
            <div className="relative mx-auto border-gray-800 bg-gray-800 border-14 rounded-[2.5rem] h-150 w-75 shadow-2xl flex flex-col overflow-hidden">
              ...
              <div className="rounded-4xl overflow-hidden w-full h-full bg-white relative">
                ...
                <div className="absolute inset-0 bg-linear-to-br from-pasPink to-pasGreen opacity-90 flex flex-col items-center justify-center text-gray-900 p-6 text-center">
                  <div className="w-20 h-20 bg-white/20 backdrop-blur-md rounded-3xl flex items-center justify-center mb-6 shadow-lg">
                    <LuDumbbell className="w-10 h-10 text-gray-900" />
                  </div>
                  <h3 className="text-2xl font-bold mb-2">Seu Plano</h3>
                  <p className="text-gray-800 mb-8">Personalizado para você</p>
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white p-4 rounded-xl shadow-lg flex items-center gap-3">
                  <div className="bg-pasGreen p-2 rounded-lg text-gray-800">
                    <LuTimer />
                  </div>
                  <div>
            ...
            >
              <div className="bg-pasPink/30 p-2 rounded-lg text-gray-900">
                <LuUtensils />
              </div>
              <div>
            ...
            >
              <div className="bg-pasGreen/30 p-2 rounded-lg text-gray-900">
                <LuLineChart />
              </div>
              <div>
      ...
      <section className="py-20 px-6 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2 relative">
            {/* Círculo decorativo */}
            <div className="absolute inset-0 bg-linear-to-tr from-pasPink to-pasGreen rounded-full blur-3xl opacity-50 scale-90" />
            <div className="relative bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-pasPink text-gray-900 p-3 rounded-xl">
      ...
      {/* --- CTA FINAL --- */}
      <section className="py-24 px-6 bg-linear-to-br from-pasPink to-pasGreen text-gray-900 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight">
            Descubra o potencial do seu corpo
          </h2>
          <p className="text-gray-800 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            Junte-se a milhares de usuários que já transformaram seus hábitos.
            Comece com uma análise profissional gratuita.
          </p>
          <button
            onClick={() => navigate("/onboard")}
            className="px-10 py-5 bg-white text-gray-900 rounded-full font-extrabold text-xl shadow-2xl hover:bg-gray-50 transition-transform hover:scale-105 active:scale-100"
          >
