...
export const personalSchema = z.object({
  ...
  email: z.email(), // NOT NULL
  peso_alvo_kg: z.number().nullable(), // peso_alvo_kg DECIMAL(5,2), DEFAULT NULL
  dias_treino: z.array(diaSemanaSchema), // DEFAULT NULL
...
// Renomeado para IMeasurementsData para refletir que é a interface de dados
